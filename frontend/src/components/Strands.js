...
// Ambient WebGL background (React Bits "Strands"). Purely decorative --
// pointer-events are left to the caller's CSS, and callers should skip
// rendering this under prefers-reduced-motion (see CallDetail.js).
